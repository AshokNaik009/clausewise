...
export const COMPATIBILITY_OPTIONS: readonly Option[] = [
  ...
  { path: "display.charset", target: "charset", env: "CHARSET", schema: z.enum(["unicode", "ascii", "auto"]) },
  { path: "display.hide_git_branch", target: "hideGitBranch", env: "HIDE_GIT_BRANCH", schema: z.boolean() },
  { path: "display.show_reasoning", target: "showReasoning", env: "SHOW_REASONING", schema: z.boolean() },
